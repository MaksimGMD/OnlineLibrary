        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mt-2">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Заполните дату" ControlToValidate="tbData" CssClass="Error" Display="Dynamic"></asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8 mt-2">
