<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/ControlPanel/ControlPanel.Master" AutoEventWireup="true" CodeBehind="GenrePage.aspx.cs" Inherits="LibraryOnline.Pages.ControlPanel.GenrePage" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 mt-2">
                <asp:TextBox ID="tbGenreName" runat="server" CssClass="tbForm" placeholder="Название жанра" MaxLength="30"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Введите название жанра"
                    Display="Dynamic" CssClass="Error" ControlToValidate="tbGenreName"></asp:RequiredFieldValidator>
            </div>
        </div>
    ...
    <div class="grid-system mt-5">
        ...
        <div class="table" style="overflow-x: auto; width: 100%; text-align: center">
            <asp:GridView ID="gvGenre" runat="server" AllowSorting="true"
                CssClass="table table-condensed table-hover" UseAccessibleHeader="true" CurrentSortDirection="ASC" Font-Size="14px"
                AlternatingRowStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" OnSorting="gvGenre_Sorting" OnRowDataBound="gvGenre_RowDataBound" OnSelectedIndexChanged="gvGenre_SelectedIndexChanged" OnRowDeleting="gvGenre_RowDeleting">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
