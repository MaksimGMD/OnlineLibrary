...
namespace LibraryOnline.Pages.ControlPanel
{
    public partial class EmployeeAccPage : System.Web.UI.Page
    {
        ...
        protected void gvEmployee_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            System.Web.UI.WebControls.CheckBox checkBox = (CheckBox)gvEmployee.Rows[selectedRow].Cells[11].Controls[0];
            ...
            Pay = rows.Cells[17].Text.ToString();
        ...
        protected void btDOCX_Click(object sender, EventArgs e)
        {
            ...
            //var Contract_Number = tbContractNumber.Text.ToString();
            //var Contract_Date = tbContractDate.Text.ToString();
            //var Surname_Employee = tbSurname.Text.ToString();
            //var Name_Employee = tbName.Text.ToString();
            //var Middle_Name_Employee = tbMiddleName.Text.ToString();
            //var Position_Name = ddlPosition.SelectedItem.Text.ToString();
            //var Passport_Number = tbPassportNumber.Text.ToString();
            //var Passport_Series = tbPassportSeries.Text.ToString();
            //if (SaveDoc.ShowDialog() == DialogResult.OK)
            //{
                //CreateWordDocument("C:/Users/maksg/source/repos/LibraryOnline/LibraryOnline/Content/Contract.doc", "Employee.doc");
            //}
        }
        //Экспорт в Excel
        ...
        //        //Поиск и замена:
        //        this.FindAndReplace(wordApp, "{Contract_Date}", tbContractDate.Text);
        //        this.FindAndReplace(wordApp, "{Surname_Employee}", tbSurname.Text);
        //        this.FindAndReplace(wordApp, "{Name_Employee}", tbName.Text);
        //        this.FindAndReplace(wordApp, "{Middle_Name_Employee}", tbMiddleName.Text);
        //        this.FindAndReplace(wordApp, "{Position_Name}", ddlPosition.SelectedItem.Text.ToString());
        //        this.FindAndReplace(wordApp, "{Pay}", Pay);
        //        this.FindAndReplace(wordApp, "{Passport_Number}", tbPassportNumber.Text);
        //        this.FindAndReplace(wordApp, "{Passport_Series}", tbPassportSeries.Text);
        //    }
        //    else
        //    {
        //        System.Windows.Forms.MessageBox.Show("Файл не существует.");
        //        return;
        //    }
